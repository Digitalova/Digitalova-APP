  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://digitalova.be/rgpd" />

        <title>RGPD - Politique de Protection des Données | DIGITALOVA</title>
        <meta
          name="description"
          content="Découvrez la politique RGPD de DIGITALOVA : données collectées, finalités, base légale, durée de conservation, cookies, sécurité et droits des utilisateurs."
        />
        ...
        <meta property="og:url" content="https://digitalova.be/rgpd" />
        <meta property="og:title" content="RGPD - Politique de Protection des Données | DIGITALOVA" />
        <meta
          property="og:description"
          content="Politique RGPD de DIGITALOVA : données collectées, finalités, base légale, destinataires, conservation, droits et cookies."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="RGPD - Politique de Protection des Données | DIGITALOVA" />
        <meta
          name="twitter:description"
          content="Consultez la politique RGPD de DIGITALOVA : vos droits, cookies, sécurité, conservation et traitement des données."
        />
        <meta
          name="twitter:image"
          content="https://mzeisxseqdcxwgyjpajm.supabase.co/storage/v1/object/public/Brand/IMagePourPortfoliog.jpeg"
