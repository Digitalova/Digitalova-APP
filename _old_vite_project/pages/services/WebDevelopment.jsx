...
const WebDevelopment = () => {
  ...
  return (
    <>
      <Helmet>
        <html lang="fr-BE" />
        <title>Création de Sites Web à Mons - Vitrine & E-commerce | DIGITALOVA</title>
        <meta
          name="description"
          content="Création de sites web professionnels à Mons : vitrine, e-commerce, sur mesure. Design moderne, performance optimale et SEO intégré. Devis gratuit."
        />
        <link rel="canonical" href="https://digitalova.be/services/creation-site-web" />
        <meta name="robots" content="index, follow, max-image-preview:large" />
        <meta name="author" content="Digitalova - Agence Web Mons" />
        <meta name="publisher" content="Digitalova" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://digitalova.be/services/creation-site-web" />
        <meta property="og:title" content="Création de Sites Web à Mons | DIGITALOVA" />
        <meta
          property="og:description"
          content="Sites web professionnels sur mesure à Mons : vitrine, e-commerce, design moderne et performance optimale."
        />
          ...
          <div className="mb-16 max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              >
                ...
                >
                  <Link to="/contact" title="Demander un devis gratuit" aria-label="Demander un devis gratuit">
                    <Button
                      size="lg"
                  ...
                  <Link to="/portfolio" title="Voir des exemples" aria-label="Portfolio">
                    <Button
                      size="lg"
                      variant="outline"
          ...
          <div className="mb-20 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {portfolioProjects.map((project, index) => (
                <Link key={index} to={project.url} title={project.seoTitle} aria-label={project.seoTitle}>
                  <motion.div
            ...
            <div className="text-center mt-10">
              <Link to="/portfolio" title="Voir tous les projets" aria-label="Voir tous les projets">
                <Button
                  size="lg"
                  variant="outline"
