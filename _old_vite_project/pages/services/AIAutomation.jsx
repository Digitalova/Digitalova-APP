...
const AIAutomation = () => {
  ...
  return (
    <>
      <Helmet>
        <html lang="fr-BE" />
        <title>Automatisation IA & Chatbots à Mons | DIGITALOVA</title>
        <meta
          name="description"
          content="Automatisation intelligente : chatbots, workflows et agents IA. Gagnez du temps, augmentez votre productivité et connectez vos outils."
        />
        <link rel="canonical" href="https://digitalova.be/services/automatisation-ia" />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="Digitalova - Agence Web Mons" />
        <meta name="publisher" content="Digitalova" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://digitalova.be/services/automatisation-ia" />
        <meta property="og:title" content="Automatisation IA & Chatbots à Mons | DIGITALOVA" />
        <meta
          property="og:description"
          content="Solutions d'automatisation intelligente : chatbots, workflows, agents IA pour gagner du temps et augmenter votre productivité."
        />
