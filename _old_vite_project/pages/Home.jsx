...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <html lang="fr-BE" />
        <title>Création de Sites Web à Mons - DIGITALOVA</title>

        <meta
          name="description"
          content="Besoin d'un site web ? Je crée votre site internet, blog ou boutique en ligne. Design adapté aux mobiles et gestion simplifiée. Devis gratuit sans engagement à Mons."
        />
        <link rel="canonical" href="https://digitalova.be/" />
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {featuredProjects.map((project, idx) => (
                ...
                >
                  <Link to={project.url} className="group block h-full" title={project.seoTitle}>
              ...
              >
                ...
                <div className="relative p-8 flex flex-col h-full">
                  ...
                  <div className="mt-8 flex justify-center">
                    <Link to="/contact" className="w-full max-w-[240px]">
