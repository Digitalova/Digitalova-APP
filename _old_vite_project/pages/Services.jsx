...
const Services = () => {
  return (
    <>
      <Helmet>
        <html lang="fr-BE" />
        <title>Mes Solutions Web & Marketing à Mons | DIGITALOVA</title>
        <meta
          name="description"
          content="Découvrez mes solutions : création de sites web, SEO, Google Business Profile et automatisation IA. Des outils concrets pour faire grandir votre activité."
        />
        <link rel="canonical" href="https://digitalova.be/services" />
        <meta name="robots" content="index, follow, max-image-preview:large" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0" />
        <meta name="author" content="Digitalova - Agence Web" />
        <meta name="publisher" content="Digitalova" />

        <meta property="og:type" content="website" />
        <meta property="og:locale" content="fr_BE" />
        <meta property="og:site_name" content="DIGITALOVA" />
        <meta property="og:url" content="https://digitalova.be/services" />
        <meta property="og:title" content="Mes Solutions Web & IA | DIGITALOVA" />
        <meta
          property="og:description"
          content="Site web, SEO, Google Business Profile et automatisation IA : découvrez la solution adaptée à votre projet."
        />
        <meta property="og:image" content={HERO_IMG} />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Mes Solutions Web & IA | DIGITALOVA" />
