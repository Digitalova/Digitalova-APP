...
const Portfolio = () => {
  ...
  return (
    <>
      <Helmet>
        <html lang="fr-BE" />
        <title>Portfolio - Réalisations de Sites Web à Mons | DIGITALOVA</title>
        <meta
          name="description"
          content="Découvrez les créations de Sites Web par DIGITALOVA à Mons : e-commerce, sites vitrines, plateformes d'automatisation IA sur mesure pour les entreprises."
        />
        <link rel="canonical" href="https://digitalova.be/portfolio" />
  ...
  <meta property="og:url" content="https://www.digitalova.be/portfolio" />
  <meta property="og:title" content="Portfolio DIGITALOVA | Nos réalisations Web à Mons" />
  <meta property="og:description" content="Explorez nos derniers projets : du restaurant italien au cabinet d'avocat. Design premium et performance SEO." />
  <meta property="og:image" content="https://mzeisxseqdcxwgyjpajm.supabase.co/storage/v1/object/public/Brand/IMagePourPortfoliog.jpeg" />
